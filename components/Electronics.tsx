...
const categories = [
  ...
  },
  {
    ...
    description: "From stick cleaners to robotic vacuums for effortless cleaning.",
  ...
  },
  {
    ...
    description: "Immersive sound systems and portable speakers.",
  ...
  },
  {
    ...
    description: "Reliable power solutions to protect your appliances.",
    image: stabilizer,
    icon: "bolt"
  },
  {
    title: "Electric Cookers & Kettles",
    description: "Convenient electric cooking solutions for fast meals.",
    image: electriccookers,
    icon: "soup_kitchen"
  },
  {
    title: "Air Conditioners",
    description: "Beat the heat with rapid cooling inverter technology.",
    image: airconditioners,
    icon: "ac_unit"
  },
  {
    title: "Microwaves & Ovens",
    description: "Bake, grill, and reheat with precision.",
      ...
      <div className="layout-container mx-auto px-4 md:px-8 xl:px-40">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {categories.map((cat, index) => (
            <div
              key={index}
              className="group bg-white rounded-3xl overflow-hidden border border-gray-200 shadow-lg hover:shadow-xl hover:border-primary/30 transition-all duration-300 flex flex-col"
            >
              ...
              <div className="p-6 flex-1 flex flex-col">
                <h3 className="text-2xl font-bold mb-2 text-[#111814] group-hover:text-primary transition-colors">
                  {cat.title}
                </h3>
                ...
                <div className="mt-auto">
                  <button
                    className="w-full py-3 rounded-xl text-sm font-bold border-2 border-gray-300 text-gray-800 bg-white transition-all duration-300 flex items-center justify-center gap-2
