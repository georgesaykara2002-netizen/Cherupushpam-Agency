    ...
    <section className="py-16">
      <div className="layout-container mx-auto px-4 md:px-8 xl:px-40">
        <div className="flex justify-between items-end mb-10">
          <div>
            <h2 className="text-[#111814] dark:text-white text-3xl font-bold leading-tight">Our Collection</h2>
            <p className="text-gray-500 mt-2">Discover premium appliances for your home</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {categories.map((item, index) => (
            <div
              key={index}
              className="group relative rounded-2xl bg-white dark:bg-surface-dark overflow-hidden border border-gray-100 dark:border-white/5 hover:border-primary/50 transition-all shadow-sm hover:shadow-md"
            >
              <div
              ...
              <div className="absolute bottom-0 left-0 w-full p-6">
                ...
                >
                  View Models <span className="material-symbols-outlined text-sm">arrow_outward</span>
                </button>
              </div>
            </div>
          ))}
