...
<div 
  ...
  className="min-h-screen bg-background-light dark:bg-background-dark pt-32 pb-16"
>
...
<h1 itemProp="name" className="text-4xl md:text-5xl font-black text-[#111814] dark:text-white mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="relative rounded-3xl overflow-hidden h-[500px] shadow-2xl group border border-gray-200 dark:border-white/10 bg-white">
             {/* Note: Replace this URL with your actual uploaded image path */}
            <img 
  src={picture} 
...
/>
             ...
             <div className="absolute inset-0 bg-gradient-to-t from-[#002b4d]/90 via-transparent to-transparent flex items-end p-8">
               <div className="bg-white/10 backdrop-blur-md p-5 rounded-2xl border border-white/20 w-full shadow-lg">
                 <p className="text-white font-black text-xl tracking-wide">Mr. Tom Cherupushpam</p>
                 <p className="text-primary text-xs font-bold uppercase tracking-[0.2em] mt-1">Managing Director</p>
               </div>
             </div>
          </div>
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-[#111814] dark:text-white flex items-center gap-3">
              Our Journey
...
In 1974, recognizing the growing needs of the expatriate and NRI community in Kottayam, Cherupushpam Agency expanded its services by launching the Foreign Exchange (Forex) division and Home Appliances segment. Under the leadership of Tom Cherupushpam, the agency has modernized its operations with advanced financial systems and premium home appliance solutions, while preserving its core values of trust, transparency, and personalized service, serving customers reliably for over 50 years.            </p>
            ...
            <div className="grid grid-cols-2 gap-6 pt-4">
               <div className="bg-white dark:bg-white/5 p-6 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
                 ...
                 <p className="text-sm font-bold text-gray-500 uppercase tracking-wider">Years of Trust</p>
               </div>
               <div className="bg-white dark:bg-white/5 p-6 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm">
                 <p className="text-4xl font-black text-primary">100k+</p>
                 <p className="text-sm font-bold text-gray-500 uppercase tracking-wider">Clients Served</p>
               </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20">
           <div className="bg-white dark:bg-surface-dark p-10 rounded-3xl border border-gray-100 dark:border-white/5 shadow-lg">
             <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-xl flex items-center justify-center text-accent-blue dark:text-primary mb-6">
               <span className="material-symbols-outlined text-2xl">flag</span>
             </div>
             <h3 className="text-2xl font-bold text-[#111814] dark:text-white mb-4">Our Mission</h3>
             <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
           ...
           <div className="bg-white dark:bg-surface-dark p-10 rounded-3xl border border-gray-100 dark:border-white/5 shadow-lg">
             ...
             <h3 className="text-2xl font-bold text-[#111814] dark:text-white mb-4">Our Vision</h3>
             <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <div className="bg-[#002b4d] rounded-3xl p-12 text-center text-white">
          ...
          <div className="flex justify-center gap-16 flex-wrap">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-primary text-xs font-bold tracking-widest uppercase">Founder</p>
            </div>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-primary text-xs font-bold tracking-widest uppercase">Managing Director</p>
            </div>
